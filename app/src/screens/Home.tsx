export function Home({
  ...
  return (
    <main className="flex items-center px-5 sm:px-12 py-14 sm:py-0 sm:min-h-screen">
      <div className="w-full max-w-3xl mx-auto sm:py-12">
        <p className="text-[11px] tracking-[0.15em] text-brass mb-3">GESTÃO DE ORÇAMENTOS</p>
        <h1 className="font-display font-semibold text-3xl sm:text-5xl text-ink leading-[1.1] sm:leading-[1.05] mb-10 sm:mb-12 max-w-xl">
        ...
        <div className="grid sm:grid-cols-2 gap-px bg-line">
          <button
            onClick={onNovo}
            className="bg-paper hover:bg-ink hover:text-paper transition-colors text-left p-6 sm:p-8 group"
          >
            <span className="block text-[11px] tracking-wide text-brass mb-4 group-hover:text-brass">
              01
            </span>
            <span className="block font-display font-semibold text-xl sm:text-2xl mb-2">
              Criar orçamento
            </span>
